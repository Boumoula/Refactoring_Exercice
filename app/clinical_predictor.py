...
if __name__ == "__main__":
    ...
    trainer = Trainer("C:/Users/pc/PycharmProjects/exercice_dapplication_GL/data/patients_infectes.csv")
    trained_model = trainer.train_model()

    # 2. Charger le dataset brut
    dataset = PatientDataset("C:/Users/pc/PycharmProjects/exercice_dapplication_GL/data/patients_infectes.csv")
    dataset.load()
